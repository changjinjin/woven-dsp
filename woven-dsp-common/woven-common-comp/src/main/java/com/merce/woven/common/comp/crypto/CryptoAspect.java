...
import com.merce.woven.common.crypto.method.CryptoMethodInvoker;
...
public class CryptoAspect {
    ...
    @Pointcut("execution(* com.merce.woven..*(..)) && @annotation(com.merce.woven.common.crypto.annotation.Cryptoable)")
