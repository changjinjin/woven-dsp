package com.merce.woven.common.jpa.criteria.query;
...
public class JpaCriteriaHelper<T> {
	 ...
	 *
	 * @param fieldName
	 *            Nome da propriedade é necessário que valor complemente
	 *            {@link Comparable})</b>
	 * @param value
	 *            Valor
	 * @return objeto de consulta
	 ...
	 *            Nome da propriedade
	 * @param comparator
	 *            Comparador BETWEEN (apenas este é aceito para este método)
	 * @param valueIni
	 *            Valor inicial <b>(necessita implementar
	 *            {@link Comparable})</b>
	 * @param valueEnd
	 *            Valor final <b>(necessita implementar {@link Comparable})</b>
	 * @return objeto de consulta
	 */
	 ...
	 *
	 * @param fieldNames
	 *            Nome das propriedades é necessário que valor complemente
	 *            {@link Comparable})</b>
	 * @param value
	 *            Valor
	 * @return objeto de consulta
	...
	private <E, Y> void groupBy(CriteriaQuery<E> criteriaQuery, Root<Y> root) {
		if (!groups.isEmpty()) {
			for (GroupBy groupField : groups) {
				criteriaQuery.multiselect(criteriaBuilder.count(root.get("id")), root.get(groupField.fieldName));
	 ...
	 *
	 * @param pageNumber
	 *            Número da página (informe <b>null</b> para desativar a página)
	 * @return objeto de consulta
	 */
	 ...
	 *
	 * @param tupleClazz
	 *            POJO de retorno para a busca.
	 * @param columns
	 *            colunas que se deseja trazer da entityClass T.
	 *
	 * @return
	 */
