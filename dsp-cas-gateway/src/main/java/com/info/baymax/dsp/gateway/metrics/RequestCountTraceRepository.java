...
public class RequestCountTraceRepository implements HttpTraceRepository {
    private static final Logger logger = LoggerFactory.getLogger(RequestCountTraceRepository.class);
        ...
        synchronized (this.traces) {
            ...
            if (path != null && !(path.lastIndexOf(".js") >= 0 || path.lastIndexOf(".html") >= 0
                ...
                if (this.reverse) {
                    ...
                    logger.trace("Request:" + trace.getRequest().getUri() + ", Response Status:"
