...
JVM_OPTS="${JVM_OPTS} -classpath ${WOVEN_CONF}:${YARN_CONF_DIR}:lib/*:${SPARK_HOME}/jars/*:${ALL_EXTRA_CLASSPATH:-.} com.merce.woven.dsp.access.platform.Starter"
