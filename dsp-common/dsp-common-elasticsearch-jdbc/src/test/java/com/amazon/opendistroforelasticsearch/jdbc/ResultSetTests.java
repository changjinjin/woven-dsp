...
public class ResultSetTests implements WireMockServerHelpers {
    ...
    void testResultSetOnPaginatedResponse(WireMockServer mockServer) throws SQLException, IOException {
        ...
        con = new ElasticsearchDriver().connect(getBaseURLForMockServer(mockServer), null);
    ...
    void testResultSetWrapper() throws SQLException {
        ElasticsearchResultSet rsImpl = new ElasticsearchResultSet(mock(ElasticsearchStatement.class), mock(QueryResponse.class), NoOpLogger.INSTANCE);
