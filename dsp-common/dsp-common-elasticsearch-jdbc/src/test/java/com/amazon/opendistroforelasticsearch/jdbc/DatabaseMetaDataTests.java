...
public class DatabaseMetaDataTests {
    ...
    void testGetColumnsWithoutColumnNamePattern() throws Exception {
        ...
        ColumnMetadataStatement stmt = new ColumnMetadataStatement((ElasticsearchConnectionImpl)con, "TABLE_%", null, NoOpLogger.INSTANCE);
    ...
    void testGetColumnsWithColumnNamePattern() throws Exception {
        ...
        ColumnMetadataStatement stmt = new ColumnMetadataStatement((ElasticsearchConnectionImpl)con, "TABLE_%", "COLUMN_%", NoOpLogger.INSTANCE);
    ...
    private Connection getMockConnection() throws ResponseException, IOException, SQLException {
        ...
        Connection con = new ElasticsearchConnectionImpl(mock(ConnectionConfig.class),
