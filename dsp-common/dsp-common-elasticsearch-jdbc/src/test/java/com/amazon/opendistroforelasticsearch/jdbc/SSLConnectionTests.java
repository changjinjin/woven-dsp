...
public class SSLConnectionTests {
    ...
    void testTrustSelfSignedEnabled() throws Exception {
        ...
        Connection con = Assertions.assertDoesNotThrow(() -> new ElasticsearchDriver().connect(connectURL, props));
    ...
    void testTrustSelfSignedDisabled() {
        ...
        SQLException sqle = Assertions.assertThrows(SQLException.class, () -> new ElasticsearchDriver().connect(connectURL, props));
    ...
    void testTrustSelfSignedDefault() {
        SQLException sqle = Assertions.assertThrows(SQLException.class, () -> new ElasticsearchDriver().connect(connectURL, null));
