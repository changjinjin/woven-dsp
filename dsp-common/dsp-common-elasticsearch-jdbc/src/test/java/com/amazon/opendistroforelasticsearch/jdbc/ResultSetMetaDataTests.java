...
/**
 * Unit tests for {@link ElasticsearchResultSetMetaData}
 */
public class ResultSetMetaDataTests {

    private ElasticsearchResultSetMetaData metaData;

    @BeforeEach
    public void setUp() {
        ElasticsearchResultSet resultSet = mock(ElasticsearchResultSet.class);
        ...
        metaData = new ElasticsearchResultSetMetaData(resultSet, schema);
    }
