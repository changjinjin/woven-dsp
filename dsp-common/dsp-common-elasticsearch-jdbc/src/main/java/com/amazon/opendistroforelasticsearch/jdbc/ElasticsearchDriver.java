...
public class ElasticsearchDriver implements java.sql.Driver, LoggingSource {
    ...
    static {
        try {
            java.sql.DriverManager.registerDriver(new ElasticsearchDriver());
    ...
    public Connection connect(String url, Properties info) throws SQLException {
        ...
        return new ElasticsearchConnectionImpl(connectionConfig, log);
    }
