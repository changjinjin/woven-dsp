 ...
 * The lookup
 */
public class ElasticsearchResultSet implements ResultSet, JdbcWrapper, LoggingSource {

    private ElasticsearchStatement statement;
    ...
    public ElasticsearchResultSet(ElasticsearchStatement statement, QueryResponse queryResponse, Logger log) throws SQLException {
        this(statement, queryResponse.getColumns(), queryResponse.getRows(), queryResponse.getCursor(), log);
    }

    public ElasticsearchResultSet(ElasticsearchStatement statement, List<? extends ColumnDescriptor> columnDescriptors,
    ...
    protected void buildNextPageFromCursorId() throws SQLException {
        try {
            ...
            ElasticsearchConnectionImpl connection = (ElasticsearchConnectionImpl) statement.getConnection();
            ...
            cursor = new Cursor(cursor.getSchema(), getRowsFromDataRows(queryResponse.getRows()));
    ...
    public ResultSetMetaData getMetaData() throws SQLException {
        checkOpen();
        return new ElasticsearchResultSetMetaData(this, cursor.getSchema());
    }
