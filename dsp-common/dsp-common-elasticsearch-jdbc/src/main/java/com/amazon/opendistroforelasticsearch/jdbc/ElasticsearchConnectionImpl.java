...
public class ElasticsearchConnectionImpl implements ElasticsearchConnection, JdbcWrapper, LoggingSource {
    ...
    public ElasticsearchConnectionImpl(ConnectionConfig connectionConfig, Logger log) throws SQLException {
        this(connectionConfig, ApacheHttpTransportFactory.INSTANCE, JsonHttpProtocolFactory.INSTANCE, log);
    }

    public ElasticsearchConnectionImpl(ConnectionConfig connectionConfig, TransportFactory transportFactory,
    ...
    public Statement createStatementX() throws SQLException {
        return new ElasticsearchStatement(this, log);
    }
    ...
    private PreparedStatement prepareStatementX(String sql) throws SQLException {
        return new ElasticsearchPreparedStatement(this, sql, log);
    }
