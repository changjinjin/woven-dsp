...
public class ElasticsearchResultSetMetaData implements ResultSetMetaData, JdbcWrapper {

    private ElasticsearchResultSet resultSet;
    private Schema schema;

    public ElasticsearchResultSetMetaData(ElasticsearchResultSet resultSet, Schema schema) {
