...
public class JdbcQueryRequest implements QueryRequest {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(statement, that.statement) && Objects.equals(getParams(), that.getParams());
	}

	@Override
	public int hashCode() {
		return Objects.hash(statement, getParams());
	}
	...
	public String toString() {
		return "JdbcQueryRequest{" + "statement='" + statement + '\'' + ", fetchSize='" + fetchSize + '\''
				+ ", parameters=" + params + '}';
	}
}
