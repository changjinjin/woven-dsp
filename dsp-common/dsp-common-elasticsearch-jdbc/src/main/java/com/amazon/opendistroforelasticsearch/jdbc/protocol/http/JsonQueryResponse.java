...
public class JsonQueryResponse implements QueryResponse {
    ...
    private List<SchemaEntry> columns;
    ...
    @Override
    public List<SchemaEntry> getColumns() {
        return columns;
    }
    ...
    public void setSchema(List<SchemaEntry> columns) {
        this.columns = columns;
    }

    public void setDatarows(List<List<Object>>  rows) {
        this.rows = rows;
    }
    ...
    public boolean equals(Object o) {
        ...
        return getSize() == response.getSize() &&
                ...
                Objects.equals(columns, response.columns) &&
                Objects.equals(getRows(), response.getRows()) &&
                Objects.equals(getError(), response.getError());
    }

    @Override
    public int hashCode() {
        return Objects.hash(columns, getRows(), getSize(), getTotal(), getStatus(), getCursor(), getError());
    }
