...
//        }
        ...
        private void validateConfig() throws ConnectionPropertyException {
            ...
            if (authenticationType == AuthenticationType.NONE) {
				 ...
				 * else if (authenticationType == AuthenticationType.AWS_SIGV4 && regionConnectionProperty.getValue() ==
				 * null) {
				 * 
				 * // aws sdk auto-detection does not work for AWS ES endpoints String region =
				 * AwsHostNameUtil.parseRegion(hostProperty.getValue());
				 * 
				 * if (region == null) { throw new ConnectionPropertyException(authConnectionProperty.getKey(),
				 ...
				 * "Provide an explicit region value (e.g. us-east-1) " + "via the \"%s\" connection property.",
				 * regionConnectionProperty.getKey())); } else { regionConnectionProperty.setRawValue(region); } }
				 */
