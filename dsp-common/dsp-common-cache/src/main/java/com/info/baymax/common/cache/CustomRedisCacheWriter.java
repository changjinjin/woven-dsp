 ...
 * @since 2.0
 */
class CustomRedisCacheWriter implements RedisCacheWriter {
     ...
     * (non-Javadoc)
     *
     * @see org.springframework.data.redis.cache.RedisCacheWriter#put(java.lang.
     * String, byte[], byte[], java.time.Duration)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.springframework.data.redis.cache.RedisCacheWriter#get(java.lang.
     * String, byte[])
     */
    @Override
     ...
     *
     * @see
     * org.springframework.data.redis.cache.RedisCacheWriter#putIfAbsent(java.
     * lang.String, byte[], byte[], java.time.Duration)
     */
    @Override
     ...
     *
     * @see
     * org.springframework.data.redis.cache.RedisCacheWriter#remove(java.lang.
     * String, byte[])
     */
    @Override
     ...
     *
     * @see
     * org.springframework.data.redis.cache.RedisCacheWriter#clean(java.lang.
     * String, byte[])
     */
    @Override
    ...
    private void checkAndPotentiallyWaitUntilUnlocked(String name, RedisConnection connection) {
        ...
        try {
            ...
            // Re-interrupt current thread, to allow other participants to
            // react.
