...
public class ExampleSqlHelper {
    ...
    public static String exampleHasAtLeastOneCriteriaCheck(String parameterName) {
        StringBuilder sql = new StringBuilder();
        sql.append(
            "<bind name=\"exampleHasAtLeastOneCriteriaCheck\" value=\"@com.info.baymax.common.mybatis.mapper.example.OGNL@exampleHasAtLeastOneCriteriaCheck(");
    ...
    public static String exampleSelectColumns(Class<?> entityClass) {
        StringBuilder sql = new StringBuilder();
        sql.append("<choose>");
        sql.append("<when test=\"@com.info.baymax.common.mybatis.mapper.example.OGNL@hasSelectColumns(_parameter)\">");
    ...
    public static String exampleCountColumn(Class<?> entityClass) {
        StringBuilder sql = new StringBuilder();
        sql.append("<choose>");
        sql.append("<when test=\"@com.info.baymax.common.mybatis.mapper.example.OGNL@hasCountColumn(_parameter)\">");
    ...
    public static String exampleForUpdate() {
        StringBuilder sql = new StringBuilder();
        sql.append("<if test=\"@com.info.baymax.common.mybatis.mapper.example.OGNL@hasForUpdate(_parameter)\">");
    ...
    public static String exampleCheck(Class<?> entityClass) {
        StringBuilder sql = new StringBuilder();
        sql.append(
            "<bind name=\"checkExampleEntityClass\" value=\"@com.info.baymax.common.mybatis.mapper.example.OGNL@checkExampleEntityClass(_parameter, '");
