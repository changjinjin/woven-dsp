...
package com.info.baymax.common.config.elasticsearch.jest;
...
import com.info.baymax.common.config.elasticsearch.jest.JestProperties.Proxy;
...
@ConditionalOnExpression(value = "!'${spring.elasticsearch.jest}'.isEmpty()")
@Deprecated
