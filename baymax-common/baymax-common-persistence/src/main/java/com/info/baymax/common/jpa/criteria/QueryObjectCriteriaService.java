...
public interface QueryObjectCriteriaService<T> extends ExampleQueryService<T> {
     ...
     * @return 分页数据集
     * @see com.info.baymax.common.service.criteria.example.ExampleQueryService#selectPage(com.info.baymax.common.service.criteria.example.ExampleQuery)
     */
     ...
     * @param queryObject 查询条件
     * @return 查询的结果集
     * @see com.info.baymax.common.service.criteria.example.ExampleQueryService#selectList(com.info.baymax.common.service.criteria.example.ExampleQuery)
     */
     ...
     * @param queryObject 查询条件
     * @return 查询的单条结果
     * @see com.info.baymax.common.service.criteria.example.ExampleQueryService#selectOne(com.info.baymax.common.service.criteria.example.ExampleQuery)
     */
     ...
     * @see com.info.baymax.common.service.criteria.example.ExampleQueryService#delete(com.info.baymax.common.service.criteria.example.ExampleQuery)
     */
