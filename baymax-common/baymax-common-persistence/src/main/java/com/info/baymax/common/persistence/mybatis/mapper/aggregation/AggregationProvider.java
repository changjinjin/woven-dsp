...
import com.info.baymax.common.persistence.mybatis.mapper.example.ExampleSqlHelper;
...
public class AggregationProvider extends MapperTemplate {
    ...
    public String selectAggregationByExample(MappedStatement ms) {
        ...
        sql.append("SELECT ${@com.info.baymax.common.persistence.mybatis.mapper.aggregation.AggregationProvider@aggregationSelectClause(");
        ...
        sql.append(" ${@com.info.baymax.common.persistence.mybatis.mapper.aggregation.AggregationProvider@aggregationGroupBy(");
        sql.append("@").append(entityClass.getCanonicalName()).append("@class");
        sql.append(", '").append(getConfig().getWrapKeyword()).append("'");
        sql.append(", aggregateCondition");
        sql.append(")} ");
