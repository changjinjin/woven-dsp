...
public class ConnectionImpl implements ElasticsearchConnection, JdbcWrapper, LoggingSource {
	...
	public ConnectionImpl(ConnectionConfig connectionConfig, TransportFactory transportFactory,
		...
		try {
			...
			logAndThrowSQLException(log, new SQLNonTransientException(
	...
	private void validateResultSetCharacteristics(int resultSetType, int resultSetConcurrency, int resultSetHoldability)
		throws SQLException {
