package com.info.baymax.dsp.auth.config.swagger.api;
 ...
 */
public class OauthAuthorizeApiDescription implements SwaggerAdditionApiDescription {

	@Override
	public ApiDescription get() {
		return new ApiDescription("Auth",AuthConstants.TOKEN_AUTHORIZE_ENTRY_POINT, // url
				"资源授权端点", // 描述
