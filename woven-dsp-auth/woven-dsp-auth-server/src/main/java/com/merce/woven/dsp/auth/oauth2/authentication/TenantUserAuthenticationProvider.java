...
import com.merce.woven.dsp.auth.security.support.tenant.TenantDetails;
import com.merce.woven.dsp.auth.security.support.tenant.TenantDetailsService;
...
public class TenantUserAuthenticationProvider implements AuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		return new TenantUserAuthenticationToken(token.getPrincipal(), token.getCredentials(), token.getClientId(),
				token.getTenant(), token.getVersion(), userDetails.getAuthorities());
	}
