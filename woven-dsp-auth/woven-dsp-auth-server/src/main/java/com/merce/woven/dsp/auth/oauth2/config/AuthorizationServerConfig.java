...
import com.merce.woven.dsp.auth.oauth2.authentication.TenantUserResourceOwnerPasswordTokenGranter;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		...
		builder//
				...
				.scopes("read", "write", "trust")//
				.autoApprove(true)//
				.authorities("WRIGTH_READ").authorizedGrantTypes("refresh_token", "authorization_code", "password",
						"tenant_password", "client_credentials");
	}
}