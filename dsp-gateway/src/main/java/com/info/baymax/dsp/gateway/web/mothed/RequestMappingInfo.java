...
public final class RequestMappingInfo implements RequestCondition<RequestMappingInfo> {
    ...
    public RequestMappingInfo getMatchingCondition(ServerWebExchange exchange) {
        ...
        /*
         * HeadersRequestCondition headers = this.headersCondition.getMatchingCondition(exchange); if (headers == null)
         * { return null; } // Match "Content-Type" and "Accept" (parsed ones and cached) before patterns
         * ConsumesRequestCondition consumes = this.consumesCondition.getMatchingCondition(exchange); if (consumes ==
         * null) { return null; } ProducesRequestCondition produces =
         * this.producesCondition.getMatchingCondition(exchange); if (produces == null) { return null; }
         */
        ...
        return new RequestMappingInfo(this.name, patterns,
            methods, params, null, null, null, custom.getCondition());
    }
