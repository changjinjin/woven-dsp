package com.info.baymax.dsp.gateway.config.sentinel;
...
public class GatewayConfiguration {
    ...
    private void initGatewayRules() {
        ...
        rules.add(new GatewayFlowRule("auth-server").setCount(10).setIntervalSec(1));
        rules.add(new GatewayFlowRule("auth-server").setCount(2).setIntervalSec(2).setBurst(2).setParamItem(
            new GatewayParamFlowItem().setParseStrategy(SentinelGatewayConstants.PARAM_PARSE_STRATEGY_CLIENT_IP)));
        rules.add(new GatewayFlowRule("access-platform").setCount(10).setIntervalSec(1));
        rules.add(new GatewayFlowRule("access-platform").setCount(2).setIntervalSec(2).setBurst(2).setParamItem(
            new GatewayParamFlowItem().setParseStrategy(SentinelGatewayConstants.PARAM_PARSE_STRATEGY_CLIENT_IP)));
