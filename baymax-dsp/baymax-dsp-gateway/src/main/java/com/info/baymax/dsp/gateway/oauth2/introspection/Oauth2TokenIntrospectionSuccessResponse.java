 ...
 */
@Immutable
public class Oauth2TokenIntrospectionSuccessResponse extends Oauth2TokenIntrospectionResponse implements SuccessResponse {
     ...
     *               {@code null}.
     */
    public Oauth2TokenIntrospectionSuccessResponse(final JSONObject params) {
        if (params.isEmpty()) {
     ...
     */
    public static Oauth2TokenIntrospectionSuccessResponse parse(final JSONObject jsonObject) throws ParseException {

        try {
            return new Oauth2TokenIntrospectionSuccessResponse(jsonObject);
     ...
     */
    public static Oauth2TokenIntrospectionSuccessResponse parse(final HTTPResponse httpResponse) throws ParseException {
