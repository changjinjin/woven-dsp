 ...
 * </ul>
 */
public abstract class Oauth2TokenIntrospectionResponse implements Response {
     ...
     */
    public Oauth2TokenIntrospectionSuccessResponse toSuccessResponse() {

        return (Oauth2TokenIntrospectionSuccessResponse) this;
    }
     ...
     */
    public Oauth2TokenIntrospectionErrorResponse toErrorResponse() {

        return (Oauth2TokenIntrospectionErrorResponse) this;
    }
     ...
     */
    public static Oauth2TokenIntrospectionResponse parse(final HTTPResponse httpResponse)
        throws ParseException {

        if (httpResponse.getStatusCode() == HTTPResponse.SC_OK) {
            return Oauth2TokenIntrospectionSuccessResponse.parse(httpResponse);
        } else {
            return Oauth2TokenIntrospectionErrorResponse.parse(httpResponse);
        }
    }
}
