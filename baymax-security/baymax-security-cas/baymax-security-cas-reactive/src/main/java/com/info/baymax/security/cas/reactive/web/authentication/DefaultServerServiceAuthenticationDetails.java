...
/**
 * A default implementation of {@link ServerServiceAuthenticationDetails} that figures out the value for
 * {@link #getServiceUrl()} by inspecting the current {@link HttpServletRequest} and using the current URL minus the
 * artifact and the corresponding value.
 *
 * @author Rob Winch
 */
final class DefaultServerServiceAuthenticationDetails extends ServerAuthenticationDetails
    implements ServerServiceAuthenticationDetails {
     ...
     *
     * @param request         the current {@link HttpServletRequest} to obtain the {@link #getServiceUrl()} from.
     * @param artifactPattern the {@link Pattern} that will be used to clean up the query string from containing the
     *                        artifact name and value. This can be created using {@link #createArtifactPattern(String)}.
     */
    DefaultServerServiceAuthenticationDetails(String remoteAddress, String sessionId, ServerHttpRequest request,
                                              String casService, Pattern artifactPattern) throws MalformedURLException {
    ...
    public boolean equals(Object obj) {
        ...
        if (!super.equals(obj) || !(obj instanceof DefaultServerServiceAuthenticationDetails)) {
            return false;
        }
        ServerServiceAuthenticationDetails that = (ServerServiceAuthenticationDetails) obj;
     ...
     */
    private String getQueryString(final ServerHttpRequest request, final Pattern artifactPattern) {
    ...
    /**
     * Creates a {@link Pattern} that can be passed into the constructor. This allows the {@link Pattern} to be reused
     * for every instance of {@link DefaultServerServiceAuthenticationDetails}.
     *
